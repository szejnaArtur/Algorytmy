...
public class ArrayTest {
    ...
    @Test
    public void sumNullArrayElementsTest(){
        Array arr = new Array(null);
        int expected = 0;
        int actual = arr.sumArrayElement();

        Assert.assertEquals(expected, actual);
    }

    @Test
    public void sumNegativeArrayElementsTest(){
        int expected = -22896;
        int actual = array.sumNegativeArrayElements();
